...
// ExtensionSet exposes read-only access to extension payloads grouped by hook and plugin.
// Plugins should use the contextual helper interfaces instead of relying on raw identifiers.
