...
// ExtensionHookContext exposes opaque references for known extension hooks available to plugins.
...
// ExtensionContributorContext exposes opaque plugin identifiers used in extension payloads.
...
// PluginRef represents an opaque reference to a plugin identifier registered on a hook.
