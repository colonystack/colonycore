...
func (emptyView) FindHousingUnit(string) (HousingUnit, bool) {
	return HousingUnit{
		HousingUnit: entitymodel.HousingUnit{},
	}, false
}
func (emptyView) FindFacility(string) (Facility, bool) {
	return Facility{
		Facility: entitymodel.Facility{},
	}, false
}
func (emptyView) FindTreatment(string) (Treatment, bool) {
	return Treatment{
		Treatment: entitymodel.Treatment{},
	}, false
}
func (emptyView) FindObservation(string) (Observation, bool) {
	return Observation{
		Observation: entitymodel.Observation{},
	}, false
}
func (emptyView) FindSample(string) (Sample, bool) {
	return Sample{
		Sample: entitymodel.Sample{},
	}, false
}
func (emptyView) FindPermit(string) (Permit, bool) {
	return Permit{
