...
// Open selects a BlobStore implementation using environment variables.
//
...
func Open(ctx context.Context) (BlobStore, error) {
...
// NewMemory returns an in-memory BlobStore (non-persistent) suitable for tests.
func NewMemory() BlobStore { return newMemoryStore() }
